...
public class OtpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        validateOtpButton.setOnClickListener(v -> {
            ...
            if (userOtp.equals(generatedOtp)) {
                ...
                Intent intent = new Intent(this, com.example.a2f_a.MainActivity.class);
    ...
    private void sendOtp() {
        ...
        com.example.a2f_a.EmailService.sendEmail(recipient, "Your OTP", "Your OTP is: " + generatedOtp);
